...
add_action('init', function() {
    add_shortcode('basket-plugin',function($atts = [], $content = null){
...
register_activation_hook( __FILE__, function(){
    ...
    $table_prefix . "inquirydetails ('id' INTEGER PRIMARY KEY AUTOINCREMENT, 'inquiryId' INTEGER, 'fullname' TEXT, 'email' TEXT, 'phoneNo' TEXT, 'spices' INTEGER)";
